...
server.registerTool('list_messages', {
    ...
    inputSchema: {
        query: z
            .string()
            .optional()
            .describe("Search query (e.g., 'is:unread', 'from:example@gmail.com')"),
        maxResults: z
            .number()
            .min(1)
            .max(100)
 ...
 */
server.registerTool('get_email_stats', {
 ...
 */
server.registerTool('batch_operation', {
    ...
    inputSchema: {
        ...
        action: z
            .enum(['read', 'unread', 'archive', 'delete', 'trash', 'spam'])
