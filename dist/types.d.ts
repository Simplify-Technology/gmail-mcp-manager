...
export declare class GmailMCPError extends Error {
    code: string;
    statusCode?: number | undefined;
    constructor(message: string, code: string, statusCode?: number | undefined);
}
export declare class AuthenticationError extends GmailMCPError {
    constructor(message: string);
}
export declare class APIError extends GmailMCPError {
